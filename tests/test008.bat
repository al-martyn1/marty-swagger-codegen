...
@rem marty-yaml2json test008_amazonaws-application-autoscaling-openapi.yaml | marty-json2yaml | marty-yaml2json >test008_amazonaws-application-autoscaling-openapi2-org.json
